...
# ASCII Art Banner
BANNER = r"""
 _______     ______    _______   __   ___   __  ___________ 
|   _  "\   /    " \  |   _  "\ |/"| /  ") |" \("     _   ")
(. |_)  :) // ____  \ (. |_)  :)(: |/   /  ||  |)__/  \\__/ 
|:     \/ /  /    ) :)|:     \/ |    __/   |:  |   \\_ /    
(|  _  \\(: (____/ // (|  _  \\ (// _  \   |.  |   |.  |    
|: |_)  :)\        /  |: |_)  :)|: | \  \  /\  |\  \:  |    
(_______/  \"_____/   (_______/ (__|  \__)(__\_|_)  \__|    
...
def init_git_repo(project_path: Path, quiet: bool = False) -> bool:
    ...
    try:
        ...
        subprocess.run(["git", "commit", "-m", "Initial commit from BobKit template"], check=True, capture_output=True)
        if not quiet:
...
def init(
    ...
    setup_lines = [
        "[cyan]BobKit Project Setup[/cyan]",
        "",
    ...
    tracker = StepTracker("Initialize BobKit Project")
