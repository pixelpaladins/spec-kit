...
#     AGENTS  : space or comma separated subset of: claude gemini copilot cursor qwen opencode codex (default: all)
...
ALL_AGENTS=(claude gemini copilot cursor qwen opencode codex kilocode auggie roo)
ALL_SCRIPTS=(sh ps)
